const currentImports = {};
      ...
      let moduleMap = {
"Extension":()=>{
      dynamicLoadingCss(["style-CDVirMqJ.css"], false, 'Extension');
      return __federation_import('./__federation_expose_Extension-DyV1-MZ3.js').then(module =>Object.keys(module).every(item => exportSet.has(item)) ? () => module.default : () => module)},};
      const seen = {};
